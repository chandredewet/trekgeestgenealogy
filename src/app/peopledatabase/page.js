  ...
  <div className="p-6">
    ...
    <div className="flex items-start">
      ...
      <div className="flex flex-col items-center ">
          <h2 className="--font-inter text-3xl"> Set up new people database</h2>
      </div>
      <div className="flex items-start">   
        <h3 className="--font-inter text-3 xl items-end px-5 py-5"> Select starter spreadsheet</h3>
      ...
      <div className="flex items-start">   
        <h3 className="--font-inter text-3 xl items-end px-5 py-5"> Select Columns</h3>
        {/* DROPDOWN (future-ready) */}
        <div className="mb-4">
          <select
            value={selectedSpreadsheetID}
